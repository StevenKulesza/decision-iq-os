...
class Index extends React.Component {
  ...
  render(){
    ...
    let galleryBackground = (frame.name !== evergreenFrame.name && selectedTemplate.visualizer && selectedTemplate.visualizer.tabKey === "frames") ? frame.image["160x600"].value : templateStyles.gallery.background_image_160x600.value;
    let evergreenFrameBackground = evergreenFrame.image["160x600"].value;
    ...
    const headerStyle = css({
      ...
      backgroundImage: templateStyles.header.background_image_160x600.value ? 'url(' + templateStyles.header.background_image_160x600.value + ')' : null,
      backgroundSize: 'cover'
    })
    
    const footerStyle = css({
      backgroundColor: templateStyles.footer.background.value,
      backgroundImage: templateStyles.footer.background_image_160x600.value ? 'url(' + templateStyles.footer.background_image_160x600.value + ')' : null,
      backgroundSize: 'cover'
    })

    const backgroundStyle = css({
      backgroundColor: templateStyles.background.background.value,
      backgroundImage: templateStyles.background.background_image_160x600.value ? 'url(' + templateStyles.background.background_image_160x600.value + ')' : null,
      backgroundSize: 'cover'
    })
    ...
    return (
      <div className={css`${display.banner160x600}` + ' ' + css`${display.bannerGlobalStyles}` + ' b160x600'}>
