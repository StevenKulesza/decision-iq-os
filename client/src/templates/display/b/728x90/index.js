...
class Index extends React.Component {
  ...
  render(){
    ...
    let galleryBackground = (selectedTemplate.visualizer && selectedTemplate.visualizer.tabKey === "frames") ? frame.image["728x90"].value : templateStyles.gallery.background_image_728x90.value;
    ...
    const headerStyle = css({
      ...
      backgroundImage: templateStyles.header.background_image_728x90.value ? 'url(' + templateStyles.header.background_image_728x90.value + ')' : null,
      backgroundSize: '100% auto',
      backgroundRepeat: 'no-repeat'
    })
    ...
    const footerStyle = css({
      ...
      backgroundImage: templateStyles.footer.background_image_728x90.value ? 'url(' + templateStyles.footer.background_image_728x90.value + ')' : null,
      backgroundSize: 'cover'
    })

    const backgroundStyle = css({
      backgroundColor: templateStyles.background.background.value,
      backgroundImage: templateStyles.background.background_image_728x90.value ? 'url(' + templateStyles.background.background_image_728x90.value + ')' : null,
      backgroundSize: 'cover'
    })
    ...
    return (
      <div className={css`${display.banner728x90}` + ' ' + css`${display.bannerGlobalStyles}` + ' b728x90'}>
