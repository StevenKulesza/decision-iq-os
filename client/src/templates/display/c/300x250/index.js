...
class Index extends React.Component {
  ...
  render(){
    ...
    const galleryImageStyle = css({
      backgroundImage: 'url(https://via.placeholder.com/150x250)',
      backgroundSize: 'cover'
    })

    return (
      <div className={css`${display.banner300x250}` + ' ' + css`${display.bannerGlobalStyles}` + ' a300x250'}>
        <div className='banner absolute'>
          <div class={backgroundStyle + " left-frame absolute"}>
            <div class="text1 absolute center-bg contain"></div>
          </div>
