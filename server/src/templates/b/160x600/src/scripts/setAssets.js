var setAssets = function (paths) {
  ...
  elem('.bg').style.backgroundImage = 'url("' + paths.styles[audienceStyle].background.background_image_160x600.imageID + '")';
  ...
  elem('.gallery').style.backgroundImage      = 'url("' + paths.styles[audienceStyle].gallery.background_image_160x600.imageID + '")';
  ...
  elem('.text1').style.backgroundImage = 'url("' + paths.styles[audienceStyle].header.background_image_160x600.imageID + '")';

  // preload images
  preloadCheck(paths.styles[audienceStyle].background.background_image_160x600.imageID, imageArray);
  preloadCheck(paths.styles[audienceStyle].gallery.background_image_160x600.imageID, imageArray);
  preloadCheck(paths.styles[audienceStyle].cta.background_image.imageID, imageArray);
  preloadCheck(paths.styles[audienceStyle].header.background_image_160x600.imageID, imageArray);
