var setAssets = function (paths) {
  ...
  elem('.bg').style.backgroundImage = 'url("' + paths.styles[audienceStyle].background.background_image_300x250.imageID + '")';
  ...
  elem('.gallery').style.backgroundImage      = 'url("' + paths.styles[audienceStyle].gallery.background_image_300x250.imageID + '")';
...
for (var i = 0; i < itemPrice.length; i++) {
  ...
  elem('.text1').style.backgroundImage = 'url("' + paths.styles[audienceStyle].header.background_image_300x250.imageID + '")';


  // preload images
  preloadCheck(paths.styles[audienceStyle].background.background_image_300x250.imageID, imageArray);
  preloadCheck(paths.styles[audienceStyle].gallery.background_image_300x250.imageID, imageArray);
  preloadCheck(paths.styles[audienceStyle].cta.background_image.imageID, imageArray);
  preloadCheck(paths.styles[audienceStyle].header.background_image_300x250.imageID, imageArray);
